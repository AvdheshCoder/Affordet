...
public class TrackOrderController {
	...
	public ModelAndView updateOrderStatus(HttpServletRequest req, HttpServletResponse res) {
		...
		String result = null;
		String customerDtl = null;
		try {
			result = customerServc.updateOrderStatus(statusId, orderId, statusDesc);
			System.out.println("order updation status is " + result);
			if ("1".equals(result)) {
				customerDtl = customerServc.getCustomerInfoForMail(orderId);
				if (customerDtl != null) {
					System.out.println("customer data is " + customerDtl);
					...
					mailMsg.append(
							"<br><br>Thanks for Shopping.<br><br><br> Best Regards,<br> Balaji Traders and Team");
