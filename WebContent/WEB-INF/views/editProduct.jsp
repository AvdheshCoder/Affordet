...
<table width="98%" border="0" cellspacing="0" cellpadding="4"
		...
		<tr>
			...
			<td width='35%'><input type="hidden" id="productId"
				name="productId" value="${listItems.productId}"></input> <input
				type="hidden" id="subCategoryId" name="subCategoryId"
				value="${listItems.subCategoryId}"></input> <input type="hidden"
				id="sellerId" name="sellerId" value="${listItems.sellerId}"></input>


				<input type="text" class="text1" value="${listItems.productName}"
				maxlength="80" id="productName" name="productName"
		...
		<tr>
			...
			<td><textarea rows="2" id="productDesc"
		...
		<tr>
			...
			<td width='35%'><input type="text" class="text1" id="discount"
		...
		<tr>
			...
			<td>Quantity</td>
			<td width='35%'><input type="text" class="text1" id="quantity"
			...
			<td width='35%'><select class="select" id="isActive"
				name="isActive" onchange="">
					<c:choose>
		...
		<tr>
			...
			<td width='35%'><input type="text" class="text1"
				value="${listItems.deliveryTime}" id="deliveryTime"
				name="deliveryTime" maxlength="1"
...
<table width="98%" border="0" cellspacing="0" cellpadding="4"
	...
	<tr>
		...
		<td width='35%' id="byteimg1"></td>
		<td colspan="3" align="left"><input type="file" name="upfile1"
			id="upfile1" /> <input type="hidden" id="image1" name="image1"
			value="0"></input> <input type="button" value="Upload"
	...
	<tr>
		...
		<td width='35%' id="byteimg2"></td>
		<td colspan="3" align="left"><input type="hidden" id="image2"
			name="image2" value="0"></input> <input type="file" name="upfile2"
	...
	<tr>
		...
		<td width='35%' id="byteimg3"></td>
		<td colspan="3" align="left"><input type="hidden" id="image3"
			name="image3" value="0"></input> <input type="file" name="upfile3"
...
<table width="98%" border="0" cellspacing="0" cellpadding="4"
	...
	<tr>
		<td width='10%'>Product Name</td>
		<td width='35%'><input type="hidden" id="productId"
			name="productId" value="${listItems.productId}" /> <input
			type="hidden" id="sellerId" name="sellerId"
			value="${listItems.sellerId}" /> <input type="text" class="text1"
			value="${listItems.productName}" maxlength="80" id="productName"
			name="productName" onclick="hideSpan('productNameError')" /></td>
		<td width=10%></td>

		<td width='10%' colspan="1" align="left">Actual Price</td>
		<td width='35%'><input type="text" class="text1" id="actualPrice"
	...
	<tr>
		...
		<td><textarea rows="2" id="productDesc" name="productDescription"
				style="width: 88%; resize: none;" maxlength="1000" value="">
									<c:out value="${fn:trim(listItems.productDescription)}"></c:out> </textarea></td>
		<td width=10%></td>
		<%-- <td width='10%' colspan="1" align="left">Discount Price</td>
			<td width='35%'><input type="text" class="text1"
				id="discountedPrice" name="discountedPrice" maxlength="4"
	...
	<tr>
		...
		<td><select class="select" id="categoryId" name="categoryId"
			onchange="">
				...
				<c:forEach var="listItem" items="${map.categoryList}">
					<c:choose>
						<c:when test="${listItems.categoryId == listItem.categoryId}">
							<option value="${listItem.categoryId}" selected="selected">${listItem.categoryName}</option>
						</c:when>
						<c:otherwise>
							<option value="${listItem.categoryId}">${listItem.categoryName}</option>
						</c:otherwise>
...
<table width="98%" border="0" cellspacing="0" cellpadding="4"
	...
	<c:forEach var="listItems" items="${map.productImages}">
		...
		<tr>
			<td width='10%'><font color="red">Main Image</font></td>
			<td width='5%' id="byteimg1"></td>
			<td align="left"><input type="file" name="upfile1" id="upfile1" />
			</td>
			<td><input type="hidden" id="image1" name="image1" value="0"></input>
		...
		<tr>
			<td width='10%'>1st Image</td>
			<td width='5%' id="byteimg2"></td>
			<td align="left"><input type="file" name="upfile2" id="upfile2" /><input
		...
		<tr>
			<td width='10%'>2nd Image</td>
			<td width='5%' id="byteimg3"></td>
			<td align="left"><input type="hidden" id="image3" name="image3"
				value="0" /> <input type="file" name="upfile3" id="upfile3" /></td>
			<td><input type="button" value="Upload"
				onclick="saveImage('upfile3','3','byteimg3','image3');" /></td>
...
<table class="nom" width="100%">
	...
	<tr>
		<td colspan="2" align="center"><input type="button"
			value="Update Product" onclick="add('EDIT');" /></td>
	</tr>
	<tr>
		<td colspan="2" align="center"><c:choose>
				<c:when test="${map.successSaved == '1'}">

					<font color="green">Product Updated successfully.</font>
