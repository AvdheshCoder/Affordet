...
<body>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td class="headerbg"><table width="100%" border="0"
						...
						<td valign="top" colspan="2">
							<div id="menu">
								<ul class="menu">
									...
									<li><a href="#" class="parent" target="_blank"><span>About
												Us</span></a></li>
									<li><a href="#" class="parent"><span>FeedBack</span></a></li>
									<li><a href="#" target="_blank"><span>FAQ</span></a></li>
